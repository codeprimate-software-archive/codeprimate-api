...
/**
 * The HttpHeader enum is an enumeration of all HTTP protocol request/response header names.
 *
 * @author John J. Blum
...
public enum HttpHeader {
  ...
  HttpHeader(final String name) {
    Assert.legalArgument(StringUtils.hasText(name),
      "The name of the HTTP protocol request/response header must be specified!");
    this.name = name;
  }
