...
/**
 * The UriUtils is an abstract utility class for processing URIs and URLs.
 * 
 * @author John J. Blum
    ...
    if (form != null) {
      for (Map.Entry<String, Object> entry : form.entrySet()) {
        ...
        if (entry.getValue() instanceof String) {
          form.put(entry.getKey(), decode(entry.getValue().toString(), encoding));
        }
      }
    }
  ...
  public static Map<String, Object> encode(final Map<String, Object> form, final String encoding) {
    if (form != null) {
      for (Map.Entry<String, Object> entry : form.entrySet()) {
        ...
        if (entry.getValue() instanceof String) {
          form.put(entry.getKey(), encode(entry.getValue().toString(), encoding));
        }
      }
    }
